...
const drawings = [
  ...
  ['b1-top-middle.png', 'Creative Passer', 'B1 Top Middle'],
  ['b1-top-right.png', 'The Prospect', 'B1 Top Right'],
  ['b1-bottom-left.png', 'Wardell', 'B1 Bottom Left'],
  ['b2-left.png', 'The Tower', 'B2 Left'],
  ['b2-middle.png', 'Spider Guard', 'B2 Middle'],
  ['b2-right.png', 'ZO2', 'B2 Right'],
  ['b3-left.png', 'The King', 'B3 Left'],
  ['b3-middle.png', 'Pickup Legend', 'B3 Middle'],
  ['b3-right.png', 'Venom', 'B3 Right'],
  ['b4-left.png', 'Paper Boi', 'B4 Left'],
  ['b4-middle.png', 'No Practice', 'B4 Middle'],
  ['b4-right.png', 'Bird', 'B4 Right'],
  ['b5-left.png', 'Post God', 'B5 Left'],
  ['b5-right.png', 'Personal Player', 'B5 Right'],
  ['b6-middle.png', 'Gold Alien', 'B6 Middle'],
  ['ball-handler.png', 'Ball Handler', 'New Drawing'],
  ['brian.png', 'Brian', 'New Drawing'],
  ['steven.png', 'Stephen', 'New Drawing'],
